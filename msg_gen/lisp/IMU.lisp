...
(cl:defmethod cl:initialize-instance :after ((m <IMU>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMU)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roi-msg:<IMU> is deprecated: use roi-msg:IMU instead.")))

(cl:ensure-generic-function 'isValidIMU-val :lambda-list '(m))
(cl:defmethod isValidIMU-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roi-msg:isValidIMU-val is deprecated.  Use roi-msg:isValidIMU instead.")
  (isValidIMU m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <IMU>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'isValidIMU) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <IMU>) istream)
  "Deserializes a message object of type '<IMU>"
    (cl:setf (cl:slot-value msg 'isValidIMU) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IMU>)))
  ...
  "897c65344524657282d14264e0b0dc3c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IMU)))
  "Returns md5sum for a message object of type 'IMU"
  "897c65344524657282d14264e0b0dc3c")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <IMU>))
  ...
  (cl:list 'IMU
    (cl:cons ':isValidIMU (isValidIMU msg))
    (cl:cons ':imu (imu msg))
))
